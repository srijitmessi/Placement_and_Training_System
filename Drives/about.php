...
<body>
				...
				<div class="top-nav">
					...
					<ul class="nav1">
						<li class="hvr-sweep-to-bottom">
								<a href="../Homepage/index.php">VT-PMS<i style="color: black;font-size: 16px;">Goto Placement Homepage</i></a>
							</li>
						<li class="hvr-sweep-to-bottom">
								<a href="index.php">Home<i style="color: black;font-size: 16px;">Get the Overview of the Site</i></a>
							</li>
							<li class="hvr-sweep-to-bottom active">
								<a href="about.php">About<i style="color: black;font-size: 16px;">About Us and our Cheif Architects</i></a>
							</li>
							<li class="hvr-sweep-to-bottom">
								<a href="products.php">Campus Drives<i style="color: black;font-size: 16px;">Campus Drives</i></a>
							</li>
							
							<li class="hvr-sweep-to-bottom">
								<a href="mail.php">Mail Us<i style="color: black;font-size: 16px;">Get in Touch with us Instantly</i></a>
							</li>
	...
	<div class="about-bottom">
		...
		<!-- container -->
		<div class="container">
			<h3 class="wow fadeInRight animated" style="visibility: visible;">A New Generation of VT</h3>
			<div class="about-bottom-grids">
				<div class="col-md-6 about-bottom-left wow fadeInLeft animated animated" data-wow-delay="0.5s" style="visibility: visible; -webkit-animation-delay: 0.5s;">
					<h4>DCC SUPPORT?</h4>
					<p>The Directorate of Campus to Corporate (DCC) plays tremendous role in empowering the students with tools for enhancing their personal and professional excellence. Vel Tech provides Outcome Based education, which in turn focuses on improving learning quotient of every individual student. The curriculum integrates skills and ideas such as project-based learning, internships with leading corporates, entrepreneurial thinking, multidisciplinary cum cross-disciplinary perspectives, and academic professional ethics. In this journey towards manoeuvres, the pragmatic DCC brings the progressive transition needed for the institution. 
					</p>
				</div>
			...
			<div class="team-info">
				...
				<div class="team-grids">
					<div class="col-md-3 team-grid wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
						 <img src="images/25.jpg" height="300px" width="250px;">
						<h6>Avinash Singh</h6>
						<p> Developer</p>
					</div>
					<div class="col-md-3 team-grid wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
						<img src="images/28.jpg" alt=""  height="300px" width="250px;">
						<h6>Srijit chakrabarty</h6>
						<p>Supporter</p>
					</div>
					<div class="col-md-3 team-grid wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
						<img src="images/26.jpg" alt=""  height="300px" width="250px;">
						<h6>Mattu</h6>
						<p> Kuch nhi kiya</p>
					</div>
					<div class="col-md-3 team-grid wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
						<img src="images/27.jpg" alt=""  height="300px" width="250px;">
						<h6>Pikachu</h6>
						<p>Pokemon</p>
					</div>
					<div class="clearfix"> </div>
		...
		<div class="footer">
			...
			<div class="container">
				...
				<div class="col-md-3 footer-right  wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h6 style="color: white">Veltech Institute of Science and Technology</h6>
					<h4>
