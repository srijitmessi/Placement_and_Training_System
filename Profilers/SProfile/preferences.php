    ...
    <div class="templatemo-flex-row">
      <div class="templatemo-sidebar">
        ...
        <div class="profile-photo-container">
          <img src="images/0.jpg" alt="Profile Photo" class="img-responsive" style="margin-left: 35px;">
          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
                <li>
                  <a href="../../Homepage/index.html" >Home VT-PMS</a>
                </li>
            ...
            <form action="pref.php" class="templatemo-login-form" method="post" enctype="multipart/form-data">
              <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">
                  ...
                  <input type="text" name="Fname" class="form-control" id="inputFirstName" placeholder="Firstname" required="">
                </div>
                <div class="col-lg-6 col-md-6 form-group">
                  <label for="inputLastName">Last Name</label>
                  <input type="text"  name="Lname" class="form-control" id="inputLastName" placeholder="Lastname" required="">
                </div>
				
				<div class="col-lg-6 col-md-6 form-group">
                  <label for="usn">VTU</label>
                  <input type="text" name="USN" class="form-control" id="usn" placeholder="VTU XXXX" required="">
                </div>
				...
				<div class="col-lg-6 col-md-6 form-group">
                  <label for="BE">Degree Aggregate</label>
