    ...
    <div class="templatemo-flex-row">
      <div class="templatemo-sidebar">
        ...
        <div class="profile-photo-container">
           <img src="0.jpg" alt="Profile Photo" class="img-responsive" style="margin-left: 35px;">
                ...
                <thead>
                  <tr>
                    ...
                    <td><a  class="white-text templatemo-sort-by">PVenue</a></td>
                       ...
                       <td><a  class="white-text templatemo-sort-by">12th/Diploma </a></td>
   <td><a  class="white-text templatemo-sort-by">Degree</a></td>               
   <td><a  class="white-text templatemo-sort-by">Backlogs</a></td>
   <td><a  class="white-text templatemo-sort-by">History of Backlogs </a></td>
 
			      <td><a  class="white-text templatemo-sort-by">Detained years</a></td>
			     
				   <td><a  class="white-text templatemo-sort-by">VTU </a></td>
...
$prev = $currentpage-1;
 ...
 ?> 
          ...
          <footer class="text-right">
              ...
              <a href="#" target="_parent">Veltech Synergy Technologies</a>			  </p>
          </footer>         
        </div>
      </div>
    </div>
