...
<html lang="en">
 ...
 <center><h2>Approved Students List of AUTO</h2></center>
...
$sql = "SELECT * FROM basicdetails where Approve='1' and Branch='AUTO' LIMIT $start_from, $num_rec_per_page"; 
...
$connect=mysqli_connect('localhost','root','');
mysqli_select_db($connect,'placement');
$sql = "SELECT * FROM basicdetails where Approve='1' and Branch='AUTO'"; 
$rs_result = mysqli_query($connect,$sql); //run the query
