          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
                  <li><a href="../../Homepage/indes.php">Home VT-PMS</a></li>
              ...
              <div class="templatemo-content-widget orangee-bg">
                ...
                <div class="media">
                  ...
                  <div class="media-body">
                    ...
                    <h2 class="media-heading text-uppercase">Update Student Details</h2><p>Update the Details of Status of Students </p>				
                  </div>        
                </div>                
              </div> 
